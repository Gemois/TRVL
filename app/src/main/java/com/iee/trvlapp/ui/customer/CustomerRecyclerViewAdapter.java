...
public class CustomerRecyclerViewAdapter extends FirestoreRecyclerAdapter<Customer, CustomerRecyclerViewAdapter.CostumerHolder> {
    private OnItemClickListener listener;
    private OnItemLongClickListener longClickListener;

    public CustomerRecyclerViewAdapter(@NonNull FirestoreRecyclerOptions<Customer> options) {
        super(options);
    }
    ...
    public void setOnItemLongClickListener(CustomerRecyclerViewAdapter.OnItemLongClickListener longClickListener) {
    ...
    protected void onBindViewHolder(@NonNull CostumerHolder holder, int position, @NonNull Customer model) {
        ...
        Package currentPackage = MainActivity.appDatabase.packagesDao().getPackageById(model.getPid());


        if (currentPackage != null) {
            Tour currentTour = MainActivity.appDatabase.toursDao().getTourById(currentPackage.getTid());
            CityHotel cityHotels = MainActivity.appDatabase.cityHotelsDao().getCityHotelById(model.getHotel());
