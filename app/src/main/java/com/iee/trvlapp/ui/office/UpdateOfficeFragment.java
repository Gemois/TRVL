...
public class UpdateOfficeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        int id = UpdateOfficeFragmentArgs.fromBundle(getArguments()).getOfficeId();
        String name = UpdateOfficeFragmentArgs.fromBundle(getArguments()).getOfficeName();
        String address = UpdateOfficeFragmentArgs.fromBundle(getArguments()).getOfficeAddress();
